...
public class CommentDaoSql {
  ...
  public static final String SELECT_AVG_SCORE_BY_DISPLAY_INFO_ID =
      "SELECT AVG(score) FROM reservation_user_comment LEFT JOIN reservation_info ON reservation_info.id = reservation_user_comment.reservation_info_id WHERE reservation_info.display_info_id = :displayInfoId";
}
