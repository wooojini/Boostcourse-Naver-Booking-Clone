...
public class ReservationApiController {
	...
	public Map<String, Object> reservations(
			@RequestParam(name="reservationEmail", required = true, defaultValue = "")String reservationEmail){	
		
		List<ReservationInfo> reservationInfos = reservationService.getReservationInfoByEmail(reservationEmail);
		...
		for(ReservationInfo reservationInfo : reservationInfos) {
			...
			int totalPrice = reservationService.getTotalPrice(reservationEmail, productId, displayInfoId, reservationDate);
	...
	public Map<String, Object> reservations(
		...
		ReservationResponse reservationResponse = reservationService.changeCancelFlagById(reservationId, cancelFlag);
	...
	public Map<String, Object> comments(@ModelAttribute @Valid CommentParam commentParam){
